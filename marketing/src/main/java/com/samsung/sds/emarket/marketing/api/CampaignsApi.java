...
public interface CampaignsApi {
    ...
    ResponseEntity<Void> deleteCampaign(@ApiParam(value = "Campaign ID", required = true) @PathVariable("id") Integer id);
     ...
     *         or No campaign with the specific id (status code 404)
     */
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "No campaign with the specific id") })
    @RequestMapping(
